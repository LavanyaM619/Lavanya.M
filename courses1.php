            ...
            <div class="faq-one">
                ...
                <div class="faq-body">
                    <p>As you register with us, you will have the opportunity to learn many new concepts,
                     ...
                     <div class="bui">
                        Basic pack
                            <form method='post' action='php/payment1.php'><input type='hidden' name='X' value='M1'> <button type='submit' >order</button></form>
                        Full pack
                        <form method='post' action='php/payment1.php'><input type='hidden' name='X' value='M2'> <button type='submit' >order</button></form>
